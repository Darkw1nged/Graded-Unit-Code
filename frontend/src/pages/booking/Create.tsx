...
const Page = () => {
    ...
    useEffect(() => {
        const getUserVehicles = async () => {
            ...
            if (isLoggedIn) {
                fetch('http://localhost:5000/booking/getUserVehicles', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
        ...
        <div className="booking-create">
            <div className="container">
                ...
                <div className="pages">
                                    ...
                                    { userProfile.addressID !== null ? (
                                        <>
                                            ...
                                            <div className="compact">
                                                ...
                                                <select name="location" id="" defaultValue={userProfile.address.country  || ''} required>
                    ...
                    <div className="booking-information hide" id="page-3">
