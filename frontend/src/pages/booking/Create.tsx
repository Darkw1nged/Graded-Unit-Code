                        ...
                        { isLoggedIn ? (
                            <form action="">
                                ...
                                { user.isCorporateUser ? (
                                    <input type="text" placeholder='Business Name' value={user.businessName}/>
                                ):(
                                    <div className="compact">
                                        <input type="text" placeholder='First Name' value={user.forename}/>
                                        <input type="text" placeholder='Last Name' value={user.lastname}/>
                                    </div>
                                )}
                                <input type="text" placeholder='Phone Number' value={user.telephone}/>
