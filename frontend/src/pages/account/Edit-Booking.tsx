    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="cost" placeholder='Cost' value={booking.cost} onChange={handleInputChange} disabled />
                
                <label htmlFor="">Paid</label>
                <input type="checkbox" name="paid" placeholder='Paid' checked={booking.paid} onChange={handleInputChange} disabled/>
