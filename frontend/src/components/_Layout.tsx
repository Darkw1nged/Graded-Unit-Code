...
const Layout = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:5000/api/v1/users/find", {
            ...
            body: JSON.stringify({ email: document.cookie.split("=")[2] })
        })
            .then(async res => {
                if (res.status === 200) {
            ...
            {isAdmin ? (
                <nav className="adminNav">
                    <div className="header">
                        ...
                        <h1>{person.forename + ' ' + person.surname || 'Welcome!'}</h1>
                    </div>
                    ...
                    <ul>
                        ...
                        <li><Link to="/admin/user-management">
                        ...
                        <li><Link to="/admin/staff-management">
                        ...
                        <li><Link to="/admin/booking-management">
                        ...
                        <li><Link to="/admin/discounts">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 3C3.39922 3.5978 4.14539 4 5 4C5.85461 4 6.60078 3.5978 7 3C7.29941 2.4022 7.85904 2 8.5 2C9.14096 2 9.70059 2.4022 10 3C10.3992 3.5978 11.1454 4 12 4C12.8546 4 13.6008 3.5978 14 3C14.2994 2.4022 14.859 2 15.5 2C16.141 2 16.7006 2.4022 17 3C17.3992 3.5978 18.1454 4 19 4C19.8546 4 20.6008 3.5978 21 3V21C20.6008 20.4022 19.8546 20 19 20C18.1454 20 17.3992 20.4022 17 21C16.7006 21.5978 16.141 22 15.5 22C14.859 22 14.2994 21.5978 14 21C13.6008 20.4022 12.8546 20 12 20C11.1454 20 10.3992 20.4022 10 21C9.70059 21.5978 9.14096 22 8.5 22C7.85904 22 7.29941 21.5978 7 21C6.60078 20.4022 5.85461 20 5 20C4.14539 20 3.39922 20.4022 3 21V3Z" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M14.3636 8.64532C14.0166 7.63623 13.0382 6.90912 11.8856 6.90912C10.4425 6.90912 9.27273 8.04876 9.27273 9.45457C9.27273 9.91821 9.39997 10.3529 9.62228 10.7273C10 11.5 10.5455 12.3017 10.5455 13.3157C10.5455 14.6569 9.58741 15.828 8.63636 16.4546H14" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M9.00001 12.2727L12.7273 12.2727" stroke="#333333" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <span>Discounts</span>
                        </Link></li>

                        <li><Link to="/admin/prices">
                    ...
                    <ul>
                        ...
                        <li><Link to={"/account/logout?email=" + document.cookie.split("=")[2]}>
                        ...
                        <div className="site">
                            ...
                            <div className="links">
                                <ul>
                                    ...
                                    <li>
                                        <Link to={"/account?email=" + document.cookie.split("=")[2]}>Account</Link>
                                    </li>
                                    <li>
